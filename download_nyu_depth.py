...
if __name__ == '__main__':
    ...
    train_data = tfds.load(args.train_dataset, data_dir=args.dataset_dir, split='train')
    valid_data = tfds.load(args.train_dataset, data_dir=args.dataset_dir, split='validation')
