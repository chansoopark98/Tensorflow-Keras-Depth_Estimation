...
BLOCK_CONFIGS = {
    "b0": {  # width 1.0, depth 1.0
        ...
        "depthes": [1, 2, 2, 3, 5, 8],
        "strides": [1, 2, 2, 2, 1, 1], #"strides": [1, 2, 2, 2, 1, 2], 
        "use_ses": [0, 0, 0, 1, 1, 1],
        "rescale_mode": "torch",
    },
...
def EfficientNetV2S(input_shape=(384, 384, 3), num_classes=1000, dropout=0.2, classifier_activation="softmax", pretrained="imagenet", **kwargs) -> tf.keras.models.Model:
