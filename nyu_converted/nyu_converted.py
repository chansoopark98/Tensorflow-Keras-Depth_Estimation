...
class NyuConverted(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            'image': tfds.features.Image(shape=(440, 586, 3), dtype=tf.uint8),
            'depth': tfds.features.Tensor(shape=(440, 586), dtype=tf.float16),
        }),
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    archive_path = dl_manager.manual_dir / 'nyu_converted.zip'
